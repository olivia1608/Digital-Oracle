...
<head>
    ...
    <title>Belanja - DigitalOracle</title>
...
<body>
    ...
    ";
                            ...
                            <d="list-view" class="tab-pane fade product-list-view active show" role="tabpanel">
                                <div class="row">
                                    < class="col">
                                            ...
                                            <div class="col-lg-5 col-md-7">
                                                <div class="product_desc">
                                                    <div class="product_desc_info">
                                                        ...
                                                        <h4><a class="product_name" href="detail_product.php?id=<?= $data['id_produk']; ?>"><?= $data['nm_produk']; ?>
                                                            </a></h4>
                                                        <div class="price-box">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="shop-add-action mb-xs-30">
                                                    <ul class="add-actions-link">
                                                        ...
                                                        <li>
                                                            < href="#" class="quick-view" data-toggle="modal" data-target="#exampleModalCenter" data-id="<?= $data['id_produk']; ?>">
                                                                <i class="fa fa-eye"></i>
                                                                </a>
                                                        </li>
                                                    </ul>
